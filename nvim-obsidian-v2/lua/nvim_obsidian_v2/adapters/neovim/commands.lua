...
function M.register(container)
    create_user_command("ObsidianV2Health", function()
        if container and container.adapters and container.adapters.notifications then
            container.adapters.notifications.info("nvim-obsidian-v2 skeleton loaded")
        end
    end, { desc = "nvim-obsidian-v2 Phase 2 health command" })
end
