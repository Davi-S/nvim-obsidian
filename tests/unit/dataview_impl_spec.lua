...
describe("dataview domain impl", function()
    ...
    it("executes TASK where/group/sort with checked and date filters", function()
        ...
        assert.equals("- [ ] Task A", out.result.rendered_lines[2].text)
        assert.equals("task_text", out.result.rendered_lines[2].highlight)
        assert.equals("2026-04-02", out.result.rendered_lines[3].text)
        assert.equals("header", out.result.rendered_lines[3].highlight)
        assert.equals("- [ ] Task B", out.result.rendered_lines[4].text)
